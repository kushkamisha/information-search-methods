...
module.exports = function (opts) {
  ...
  return {
    ...
    getRightSubtree: function (callback, currentNode) {
      currentNode = arguments.length > 1 ? currentNode : this.root;
      ...
      if (currentNode.right) {
        this.getRightSubtree(callback, currentNode.right);
      }
    },

    getRightValues: function (subtree) {

      const values = [];
      this.getRightSubtree((data) => { values.push(data.key); }, subtree);
      return values;
    },
    ...
    _insert: function (node, currentRoot) {
      ...
      } else if (node[this.key].length > currentRoot[this.key].length) {
